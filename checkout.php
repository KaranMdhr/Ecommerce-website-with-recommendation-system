  ...
  <div class="panel panel-default">
    ...
    <form action="checkout.php" method="POST">
			...
			<div class="form-group col-sm-2">
  				<label for="txtPincode">Postal Code:</label>
          ...
          <input type="hidden" id="txtTotalAmount" name="txtTotalAmount" value="<?php echo getTotalAmount(); ?>">
			...
			<div class="form-group col-sm-4">
  				...
  				<input type="text" class="form-control" readonly="readonly" value="Nepal (Service Available Nepal Only.)">
			</div>
        </div>
		<br/>
...
if (str.length == 0) {
    ...
    //  return;
      ...
      xmlhttp.onreadyprovincechange = function() {
          if (this.readyprovince == 4 && this.status == 200) {
...
{
  placeorder($_POST['txtName'],$_POST['txtEmail'],$_POST['txtPhone'],$_POST['txtAddress'],$_POST['txtLandmark'],$_POST['txtPincode'],$_POST['txtprovince'],$_POST['txtTotalAmount'],$_POST['txtCartId'],$_POST['txtDelivaryCharge'],$_POST['txtMode']);
}

		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>9849965145</li>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:boyemo728@gmail.com">boyemo728@gmail.com</a></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="wthree_footer_copy">
				<p>© 2021 All rights reserved By <strong>mobee Shoppers</strong> | Developed by by <a href="http://www.uvcweb.in/?utm=mobee" target="_blank">Nikila Perera</a></p>
			</div>
		</div>
	</div>
<!-- //footer -->

...
global $con;
	...
	{
		$value=str_replace("#ORDmobee","",$order_id);
		$sql="UPDATE `mobee_order` SET `payment`=1 WHERE `order_id`='".$value."' ";
		$con->query($sql);
		unset($_SESSION['uniqueSessionID']);

		$to = 'contact.mobeekolkata@gmail.com';
		...
		Thank you for placing an order at www.mobeePrime.com \n
		Your order no is ".$OrderId."\n
		Please log in to www.mobeePrime.com to track your order status.\n

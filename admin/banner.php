    ...
    if(isset($_POST['btnBannerUpload']))
	 {
		...
		{
	        $rand=md5(rand()).".jpg";
			move_uploaded_file($_FILES['fileBanner']['tmp_name'], "Upload/Banner/".$rand) or die("oops! multiple picture not uploaded");
                    ...
                    <div class="tab-pane active" id="info">
                       ...
                       <form role="form" action="banner.php" enctype="multipart/form-data" method="post">
	                    <div class="form-group">
	                        ...
	                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="http://Yourlink/user?getvalue" name="txtBannerURL">
	                    </div>
	                    <div class="form-group">

    ...
    if(isset($_POST['btnCreateCollection']))
	 {
		...
		{
	        $rand=md5(rand()).".jpg";
			move_uploaded_file($_FILES['fileBanner']['tmp_name'], "Upload/Collection/Banner/".$rand) or die("oops multiple picture not uploaded");

            $rand1=md5(rand()).".jpg";
            move_uploaded_file($_FILES['fileThamb']['tmp_name'], "Upload/Collection/Thamble/".$rand1) or die("oops multiple picture not uploaded");
	 ...
	 ?>
        <div class="box-inner homepage-box">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-th"></i> Collection Management</h2>
                    ...
                    <div class="tab-pane active" id="info">
                       ...
                       <form role="form" action="collection.php" enctype="multipart/form-data" method="post">
	                    <div class="form-group">
	                        ...
	                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="IPHONE COLLECTION" name="txtCollection">
	                    </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="txtDescription" placeholder="New released collection" rows="3"></textarea>
                        </div>
	                    <div class="form-group">

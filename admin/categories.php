                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active" id="info">
                       ...
                       <form role="form" action="categories.php" enctype="multipart/form-data" method="post">
	                    <div class="form-group">
	                        ...
	                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Apple,Samsung,etc" name="txtCategoryName" value="<?php if(isset($_GET['EditID'])){ echo base64_decode($_GET['Name']);} ?>">
	                    </div>
	                    <div class="form-group">
                    ...
                    <div class="tab-pane" id="custom">
                        <h3>Manage Categories
                            <small>View All Categories Or Delete Categories</small>
                        </h3>

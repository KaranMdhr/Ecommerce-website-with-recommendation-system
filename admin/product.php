	 ...
	 ?>
        <div class="box-inner homepage-box">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-th"></i> Products Management</h2>
                    ...
                    <div class="tab-pane active" id="info">
                       ...
                       <form role="form" action="product.php" enctype="multipart/form-data" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="AApple phone" name="txtProductName" value="<?php if(isset($_GET['EditID'])) {echo $EditDetails['product_name'];} ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="exampleInputPassword1" placeholder="" name="txtMRP" value="<?php if(isset($_GET['EditID'])) {echo $EditDetails['price'];} ?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputFile">Selling Price </label>
                           <input type="text" class="form-control" id="exampleInputPassword1" placeholder="" name="txtSell" value="<?php if(isset($_GET['EditID'])) {echo $EditDetails['selling'];} ?>">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputFile">Product SKU </label>
                           <input type="text" class="form-control" id="exampleInputPassword1" placeholder="" name="txtSKU" value="<?php if(isset($_GET['EditID'])) {echo $EditDetails['SKU'];} ?>">
                        </div>

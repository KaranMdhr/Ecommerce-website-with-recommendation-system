                    ...
                    <div class="tab-pane active" id="info">
                       ...
                       <form role="form" action="cod.php" enctype="multipart/form-data" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Nayabazar, Shorakhutte, Kathmandu" name="txtLocation" value="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Pin Code </label>
                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="10100" name="txtPinCode" maxlength="6" minlength="6" value="">
                        </div>
                        <div class="form-group">

	...
	<div class="footer">
		<div class="container">
				...
				<div class="col-md-6 text-right w3_footer_grid agile_footer_grids_w3_footer">
					<div class="w3_footer_grid_bottom">
						...
						<ul class="agileits_social_icons">
							...
							<li><a href="#" class="google"><i class="fa fa-github" aria-hidden="true"></i></a></li>
			...
			<div class="wthree_footer_copy">
				<p>© 2024 All rights reserved By <strong>Prime COllage</strong> | Developed by Karan Manandhar</a></p>
			</div>
		</div>
	</div>
<!-- //footer -->
